...
def step_impl(context):
    raise NotImplementedError(u'STEP: Then s.transform = identity_matrix')


@given(u't ← translation(2, 3, 4)')
def step_impl(context):
    raise NotImplementedError(u'STEP: Given t ← translation(2, 3, 4)')


@when(u'set_transform(s, t)')
def step_impl(context):
    raise NotImplementedError(u'STEP: When set_transform(s, t)')


@then(u's.transform = t')
def step_impl(context):
    raise NotImplementedError(u'STEP: Then s.transform = t')


@when(u'set_transform(s, scaling(2, 2, 2))')
def step_impl(context):
    raise NotImplementedError(u'STEP: When set_transform(s, scaling(2, 2, 2))')


@then(u'xs[0].t = 3')
def step_impl(context):
    raise NotImplementedError(u'STEP: Then xs[0].t = 3')


@then(u'xs[1].t = 7')
def step_impl(context):
    raise NotImplementedError(u'STEP: Then xs[1].t = 7')


@when(u'set_transform(s, translation(5, 0, 0))')
def step_impl(context):
    raise NotImplementedError(u'STEP: When set_transform(s, translation(5, 0, 0))')
